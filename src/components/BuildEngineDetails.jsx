...
import { Loader2, Zap, Copy, Code, GitBranch, Terminal } from 'lucide-react';
import SiteHeader from './SiteHeader.jsx'; 
import { doc, getDoc } from 'firebase/firestore'; 
import { marked } from 'marked'; // For rendering Markdown output

// Utility function to handle API calls with network resilience (copied from StrategyInterface)
...
// The file order for the Build Engine
const buildSteps = [
...
const BuildEngine = ({ onViewEngine, db, currentUser, appId, projectId, onSignOut, onOpenAuthModal, onReturnToLanding }) => {
  ...
  const startCodeGeneration = async (stepIndex) => {
    ...
    // Use the required URL format for platform API key injection.
  ...
  // 4. Handle Next/Previous File Navigation
